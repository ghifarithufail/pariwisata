...
class KotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kota')->with('success', 'Kota created successfully')->with('provinsis', Provinsi::all());
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('kota')->with('success', 'Kota updated successfully');
    }
