    ...
    public function index(Request $request)
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('armada')->with('success', 'Armada created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('layouts.admin.armada.edit', compact('armada', 'rutes'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('armada')->with('success', 'Armada updated successfully');
    }
