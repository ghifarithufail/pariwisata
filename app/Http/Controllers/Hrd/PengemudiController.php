...
class PengemudiController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('pengemudi')->with('success', 'Pengemudi have been created successfully!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('pengemudi')->with('success', 'Pengemudi berhasil diperbarui!');
        } catch (\Exception $e) {
