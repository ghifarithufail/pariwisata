...
class KaryawanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Karyawan::with(['users.biodata','biodatas', 'pools', 'rutes']);

        if ($search) {
            $query->whereHas('user.biodata', function ($q) use ($search) {
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('karyawan')->with('success', 'Karyawan have been created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('karyawan')->with('success', 'Karyawan has been updated successfully!');
    }
