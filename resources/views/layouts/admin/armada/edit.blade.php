                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="rute_id" name="rute_id" class="select2 form-select" data-allow-clear="true">
                                ...
                                @foreach($rutes as $rute)
                                    <option value="{{ $rute->id }}" {{ $armada->rute_id == $rute->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="merk" name="merk" class="select2 form-select" required>
                                ...
                                <option value="HINO RG" {{ $armada->merk == 'HINO RG' ? 'selected' : '' }}>HINO RG</option>
                                <option value="HINO RJK" {{ $armada->merk == 'HINO RJK' ? 'selected' : '' }}>HINO RJK</option>
                            </select>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="{{ route('armada') }}" class="btn btn-warning">Back</a>
                        </div>
                    </div>
                </form>
            </div>
